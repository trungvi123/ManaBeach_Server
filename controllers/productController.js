...
const uploadImgForProduct = async (req, res) => {
  try {
    ...
    if (product[0].imgs.length <= 3) {
      //https://manaserver.onrender.com/ server cá nhân
...
export { uploadImgForProduct,checkQuantity, getAllProduct, createProduct, updateProduct, deletee, deleteeAll, uploadImg }